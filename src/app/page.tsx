...
export default function Home() {
  return ( <>
      ...
      <main className="pt-20 bg-pink-300 min-h-screen shadow-lime-200">
        <section className="text-center py-16 bg-pink shadow-lime-200 shadow-lg">
        ...
        <section className=" mx-auto py-16 px-6 bg-blue-200">
